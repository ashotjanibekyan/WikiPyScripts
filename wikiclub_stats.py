...
Clubs = {
    ...
    'Գյումրի': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Գյումրու վիքիակումբ/Վիճակագրություն',
        'wikisource': 'Վիքիդարան:Կրթական ծրագիր/Գյումրու վիքիակումբ',
        'pop': 118600,
        'name': 'Գյումրի',
        'users': []
    },
    ...
    'Քաջարան': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Քաջարանի վիքիակումբ/Վիճակագրություն',
        'pop': 8200,
        'name': 'Քաջարան',
        'users': []
    },
    'Իջևան': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Իջևանի վիքիակումբ/Վիճակագրություն',
        'pop': 20800,
        'name': 'Իջևան',
        'users': []
    },
    'Արթիկ': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Արթիկի վիքիակումբ/Վիճակագրություն',
        'pop': 19500,
        'name': 'Արթիկ',
        'users': []
    },
    'Ախուրյան': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Ախուրյանի վիքիակումբ/Վիճակագրություն',
        'pop': 7000,
        'name': 'Ախուրյան',
        'users': []
    },
    'Տաշիր': {
        'wikipedia': 'Վիքիպեդիա:Կրթական ծրագիր/Տաշիրի վիքիակումբ/Վիճակագրություն',
        'pop': 12100,
        'name': 'Տաշիր',
        'users': []
    }
